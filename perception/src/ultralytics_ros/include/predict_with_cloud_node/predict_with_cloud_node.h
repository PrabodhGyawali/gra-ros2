...
class PredictWithCloudNode : public rclcpp::Node
{
private:
  ...
  float preprocessing_filter_threshold_;
...
public:
  ...
  void removeGroundPlane(const pcl::PointCloud<pcl::PointXYZ>::Ptr& input_cloud,
